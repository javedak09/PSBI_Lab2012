<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="sample_recv_20220305.aspx.cs" Inherits="PSBI_Lab2012.sample_recv_20220305" %>
                                            ...
                                            <div class="card-body">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <asp:TextBox runat="server" ID="AS1_name" class="form-control" MaxLength="50" name="AS1_name" onkeypress="return lettersOnly_WithSpace(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <asp:TextBox runat="server" ID="AS1_Q6" class="form-control" MaxLength="50" name="AS1_Q6" onkeypress="return lettersOnly_WithSpace(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <asp:Panel runat="server" ID="pnl_AS2_Q13">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="projectinput5">Name of the laboratory person receiving the sample</label>
                                                            <div class="col-md-9">
                                                                <asp:TextBox runat="server" ID="AS2_Q13" MaxLength="50" class="form-control" name="AS2_Q13" onkeypress="return lettersOnly_WithSpace(event);"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <asp:TextBox runat="server" ID="AS3_Q14" MaxLength="50" class="form-control" name="AS3_Q14" onkeypress="return lettersOnly_WithSpace(event);"></asp:TextBox>
                                                            </div>
                                                        </div>
